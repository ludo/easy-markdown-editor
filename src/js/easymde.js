...
var toolbarBuiltInButtons = {
    ...
    'strikethrough': {
        ...
        className: 'fa far fa-strikethrough',
        title: 'Strikethrough',
    },
    'heading': {
        name: 'heading',
        action: toggleHeadingSmaller,
        className: 'fa far fa-header fa-heading',
        title: 'Heading',
        default: true,
    },
    'heading-smaller': {
        ...
        action: toggleHeadingSmaller,
        className: 'fa far fa-header fa-heading header-smaller',
        title: 'Smaller Heading',
    },
    'heading-bigger': {
        name: 'heading-bigger',
        action: toggleHeadingBigger,
        className: 'fa far fa-header fa-heading header-bigger',
        title: 'Bigger Heading',
    },
    'heading-1': {
        name: 'heading-1',
        action: toggleHeading1,
        className: 'fa far fa-header fa-heading header-1',
        title: 'Big Heading',
    },
    'heading-2': {
        name: 'heading-2',
        action: toggleHeading2,
        className: 'fa far fa-header fa-heading header-2',
        title: 'Medium Heading',
    },
    'heading-3': {
        name: 'heading-3',
        action: toggleHeading3,
        className: 'fa far fa-header fa-heading header-3',
        title: 'Small Heading',
    },
    'separator-1': {
        name: 'separator-1',
    ...
    'code': {
        ...
        className: 'fa far fa-code',
        title: 'Code',
    },
    'quote': {
        name: 'quote',
        action: toggleBlockquote,
        className: 'fa far fa-quote-left',
        title: 'Quote',
        default: true,
    },
    'unordered-list': {
    ...
    'table': {
        name: 'table',
        action: drawTable,
        className: 'fa far fa-table',
        title: 'Insert Table',
    },
    'horizontal-rule': {
        name: 'horizontal-rule',
        action: drawHorizontalRule,
        className: 'fa far fa-minus',
    ...
    'fullscreen': {
        ...
        className: 'fa far fa-arrows-alt',
        noDisable: true,
        noMobile: true,
    ...
    'guide': {
        ...
        className: 'fa far fa-question-circle',
        noDisable: true,
    ...
    'redo': {
        name: 'redo',
        action: redo,
        className: 'fa far fa-repeat fa-redo',
        noDisable: true,
        title: 'Redo',
    },
};
